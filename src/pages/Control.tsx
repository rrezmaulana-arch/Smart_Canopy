...
export default function Control() {
  ...
  // Ô£¿ PERBAIKAN: Gunakan useRef untuk melacak status drag slider.
  ...
  // Ô£¿ PERBAIKAN: onChange HANYA mengubah state lokal untuk animasi UI yang mulus
  ...
  // Ô£¿ PERBAIKAN: onRelease (MouseUp/TouchEnd) baru menembak data ke Firebase
  ...
  const handleThresholdRelease = () => {
    // Ô£à Path baru: /settings/threshold
